  ...
  return (<>
    ...
    <main className={styles.myExplaination}>
      ...
      <ul style={{ listStyle: '"  ▷   "' }}>
        ...
        <h4>
          <li>
          웹 기술을 사용한 능숙한 개발을 위해 JavaScript, TypeScript 및 React를 사용한 다양한 프로젝트를 진행하였습니다. 또한 Back-end 개발자를 포함한 프로젝트 구성원과의 원활한 협업과 이해를 높이기 위해 Java, Kotlin 및 Spring 프레임워크도 직접 활용하고 개발했습니다.
          </li>
        </h4>
        <h4>
          <li>
          현업에서는 그동안 배운 모든 지식들을 활용하면서 업무를 수행하고 있습니다. 현실에 안주하는게 아닌 나아가기 위한 개발자가 되려고 공부도 병행하고 있습니다.
          </li>
        </h4>
      </ul>
    </main>
